 ...
 */
final class Version20230214122647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medicament (id INT AUTO_INCREMENT NOT NULL, ordonnance_id VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, dosage INT NOT NULL, prix DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_9A9C723A2BF23B8F (ordonnance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ordonnance (id VARCHAR(255) NOT NULL, idconsultation_id INT NOT NULL, validite INT NOT NULL, INDEX IDX_924B326C83E08C56 (idconsultation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
