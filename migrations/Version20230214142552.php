 ...
 */
final class Version20230214142552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medicament ADD ordonnance_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medicament DROP ordonnance_id, CHANGE nom nom VARCHAR(2000) NOT NULL');
    }
}
