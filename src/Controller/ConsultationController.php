...
class ConsultationController extends AbstractController
{
    ...
    #[Route('/consultation/show/{idconsultation}', name: 'app_consultation_show', methods: ['GET'])]
    ...
    #[Route('/consultation/modifier/{idconsultation}', name: 'app_consultation_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/consultation/supprimer/{idconsultation}', name: 'app_consultation_delete', methods: ['POST'])]
