...
class CalendrierController extends AbstractController
{
    ...
    public function new(Request $request, CalendrierRepository $calendrierRepository, $medecin, UtilisateurMouhebRepository $utilisateurRepository): Response
    {
    ...
    public function planning(
        UtilisateurMouhebRepository $utilisateurRepository,
    ...
    public function disponibilite(CalendrierRepository $calendrierRepository, UtilisateurMouhebRepository $utilisateurRepository, $medecin): Response
    {
