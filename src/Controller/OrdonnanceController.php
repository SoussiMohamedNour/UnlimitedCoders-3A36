...
class OrdonnanceController extends AbstractController
{
    ...
    #[Route('/ordonnance/show/{referenceordonnance}', name: 'app_ordonnance_show', methods: ['GET'])]
    ...
    #[Route('/ordonnance/modifier/{referenceordonnance}', name: 'app_ordonnance_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/ordonnance/supprimer/{referenceordonnance}', name: 'app_ordonnance_delete', methods: ['POST'])]
    public function delete(Request $request, Ordonnance $ordonnance, OrdonnanceRepository $ordonnanceRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ordonnance->getReferenceordonnance(), $request->request->get('_token'))) {
