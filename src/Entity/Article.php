...
class Article
{
  ...
  /*  #[ORM\Column(length: 2000, nullable: true)]
    ...
    #[ORM\ManyToMany(targetEntity: UtilisateurOmar::class, mappedBy: 'articles')]
    private Collection $users;

    public function __construct()
    {
        $this->commentaire = new ArrayCollection();
        $this->nblike = new ArrayCollection();
        $this->nbdislike= new ArrayCollection();
    ...
    /**
     * @return Collection<int, UtilisateurOmar>
     */
    ...
    public function addUser(UtilisateurOmar $user): self
    {
    ...
    public function removeUser(UtilisateurOmar $user): self
    {
