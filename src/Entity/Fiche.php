...
class Fiche
{
    ...
    #[ORM\ManyToMany(targetEntity: MedicamentTakwa::class, inversedBy: 'fiches')]
    ...
    /**
     * @return Collection<int, MedicamentTakwa>
     */
    ...
    public function addMedicament(MedicamentTakwa $medicament): self
    {
    ...
    public function removeMedicament(MedicamentTakwa $medicament): self
    {
